        ...
        return when (throwable) {
            ...
            is HttpException -> {
                ...
                val message = gson.fromJson<JsonObject>(
                    ...
                    if (has("error_key")) errorKey = get("error_key").asString
                    when {
...
data class Error(
    val type: ErrorType, val data: HttpErrorData? = null, val statusCode: Int? = null
)

enum class ErrorType {
    Http, Unauthorized, NoContent, Timeout, NetworkOffline, Unknown
}
